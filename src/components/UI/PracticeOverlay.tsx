...
import { getPuzzleSubcategory, SubcategoryDetails } from '../../utils/mathUtils';
...
export default function PracticeOverlay() {
  const { currentLevel, setPhase, activePuzzles, recordAttempt } = useGameStore();
  ...
  const handleAnswer = (ans: string, idx: number) => {
    ...
    recordAttempt(puzzle.q, isCorrect, elapsed);
